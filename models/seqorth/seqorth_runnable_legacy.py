#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/Seqorth/modular_Seqorth.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_Seqorth.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
def seqorth_lb_loss(
    ...
    """
    Seqorth-aligned low-overhead load balancing loss.
...
@dataclass
class SeqorthModelOutputWithPast(BaseModelOutputWithPast):
    """
    Base class for Seqorth outputs, with hidden states and attentions.
...
@dataclass
class SeqorthCausalLMOutputWithPast(ModelOutput):
    """
    Base class for Seqorth causal language model (or autoregressive) outputs.
...
class SeqorthTextScaledWordEmbedding(nn.Embedding):
    """
    🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
    TODO: THIS CODE IS CRITICAL FOR THE EXOSKELETON ARCHITECTURE. THIS CODE MUST REMOVED. Seqorth MUST BUILT AS AN EXOSKELETON ARCHITECTURE FORM BASE LARGE LANGUAGE MODEL WEIGHTS, NOT FROM SCRATCH.
    🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
    """
...
class SeqorthMLP(nn.Module):
    """
    🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
    TODO: THIS CODE IS CRITICAL FOR THE EXOSKELETON ARCHITECTURE. THIS CODE MUST REMOVED. Seqorth MUST BUILT AS AN EXOSKELETON ARCHITECTURE FORM BASE LARGE LANGUAGE MODEL WEIGHTS, NOT FROM SCRATCH.
    🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
    """
    def __init__(self, config: SeqorthTextConfig, intermediate_size: Optional[int]=None, **kwargs):
        super().__init__()
        self.config = config
        ...
        setattr(self.gate_proj, "_is_seqorth_gate_layer", True)
...
def enhanced_soft_orthogonality_loss(
    ...
    핵심 차별점:
    1. Frobenius Norm + Seqorthl Norm 결합
    ...
    if use_srip:
        # SRIP: Seqorthl norm of (G - I), bounds Lipschitz constant
...
class SeqorthRouter(nn.Module):
    ...
    def forward(self, x, hn, top_k=2, jitter_eps=0.01):
        ...
        """
        # ============================================================
        # [COMPONENT TEST MODE] SeqorthRouter 비활성화 옵션
        # ============================================================
        _TEST_MODE = os.environ.get("SEQORTH_TEST_MODE", "0") == "1"
        _DISABLE_ROUTER = os.environ.get("SEQORTH_DISABLE_ROUTER", "0") == "1"
        _DISABLE_INTENT_GATED = os.environ.get("SEQORTH_DISABLE_INTENT_GATED", "0") == "1"
        _DISABLE_EXPRESSION_PROJ = os.environ.get("SEQORTH_DISABLE_EXPRESSION_PROJ", "0") == "1"

        if _DISABLE_ROUTER:
            # 라우터 완전 비활성화: uniform routing 반환
            ...
            if _TEST_MODE:
                print(f"[TEST] SeqorthRouter disabled, returning uniform routing")
    ...
    def _forward_impl(self, x, hn, top_k=2, jitter_eps=0.01,
        ...
        if _disable_intent_gated:
            # IntentGatedContextCell 비활성화: 입력 그대로 사용
        ...
        if _disable_expression_proj:
            # ExpressionProjector 비활성화: uniform projection
...
class SeqorthMoE(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if not skip_expert_init:
            ...
            self.experts = nn.ModuleList([SeqorthMLP(config, intermediate_size=expert_intermediate_size) for _ in range(self.num_experts)])
        else:
        ...
        if self.n_shared_experts > 0:
            self.shared_experts = SeqorthMLP(config=config, intermediate_size=config.intermediate_size * self.n_shared_experts)
        else:
        ...
        setattr(self.router, "_is_seqorth_router", True)
        setattr(self.router.expression_projector, "_is_seqorth_expression_projector", True)
    ...
    def forward(
        ...
        **kwargs
        ...
        # ============================================================
        _TEST_MODE = os.environ.get("SEQORTH_TEST_MODE", "0") == "1"
        _DISABLE_SHARED_EXPERTS = os.environ.get("SEQORTH_DISABLE_SHARED_EXPERTS", "0") == "1"
    ...
    def _sparse_routing(
        ...
        # ============================================================
        _TEST_MODE = os.environ.get("SEQORTH_TEST_MODE", "0") == "1"
        _DISABLE_EXPERT_DISPATCH = os.environ.get("SEQORTH_DISABLE_EXPERT_DISPATCH", "0") == "1"
        _DISABLE_AUX_LOSSES = os.environ.get("SEQORTH_DISABLE_AUX_LOSSES", "0") == "1"
        _DISABLE_ROUTER = os.environ.get("SEQORTH_DISABLE_ROUTER", "0") == "1"
        ...
        if not isinstance(self.experts, nn.ModuleList) and callable(self.experts):
            ...
            # but Seqorth provides [N, top_k]. We must scatter them back to full width.
...
class SeqorthRMSNorm(nn.Module):
    ...
    def forward(self, x):
        ...
        # Llama does x.to(float16) * w whilst Seqorth is (x * w).to(float16)
...
# inject Seqorth's advanced routing mechanisms into any pretrained model without
...
class SeqorthExoskeletonMoEInjector:
    """
    ...
    component with Seqorth's advanced routing mechanism while preserving:
    ...
    Usage:
        ...
        injector = SeqorthExoskeletonMoEInjector(seqorth_config, seqorth_router)
        seqorth_model = injector.inject(base_model)
    """
    ...
    def __init__(
        ...
        Args:
            seqorth_config: Seqorth configuration for the MoE layer
            global_router: Pre-initialized Seqorth global router (shared across layers)
            preserve_shared_experts: If True, keep base model's shared experts frozen
            copy_expert_weights: If True, copy base model expert weights to Seqorth experts (upcycling)
        """
        self.config = seqorth_config
    ...
    def create_seqorth_moe_replacement(
        self,
        base_moe_components: dict,
        layer_idx: int,
    ) -> 'SeqorthMoE':
        """
        Create a SeqorthMoE module that replaces the base model's MoE.
        ...
        **CRITICAL**: For existing MoE models (e.g., Qwen3-VL-MoE), we REUSE the base model's
        ...
        Returns:
            SeqorthMoE: The replacement MoE module with Seqorth router and base model experts
        """
        ...
        if has_base_experts:
            ...
            seqorth_moe.experts = base_moe_components['experts']
        else:
            # No experts in base model - this is dense upcycling, keep new experts
            logger.debug(f"  Layer {layer_idx}: Base model has no experts, using newly initialized Seqorth experts")

        # Preserve shared experts if requested
        if self.preserve_shared_experts and base_moe_components['shared_experts'] is not None:
            seqorth_moe.shared_experts = base_moe_components['shared_experts']
            # Freeze shared experts to preserve pretrained behavior
            for param in seqorth_moe.shared_experts.parameters():
                param.requires_grad = False
    ...
    def inject_into_layer(self, layer, layer_idx: int, model_type: str) -> nn.Module:
        """
        Inject Seqorth MoE into a single decoder layer using surgical hijacking.

        This method is ZeRO-3 SAFE because it does not replace the module object,
        preserving original DeepSpeed hooks and metadata.
        """
        # ============================================================
        # [COMPONENT TEST MODE] Seqorth 전체 비활성화 옵션
        # ============================================================
        _DISABLE_ALL = os.environ.get("SEQORTH_DISABLE_ALL", "0") == "1"
        _TEST_MODE = os.environ.get("SEQORTH_TEST_MODE", "0") == "1"

        if _DISABLE_ALL:
            if _TEST_MODE:
                print(f"[TEST] Layer {layer_idx}: Seqorth disabled, keeping original Qwen3 MoE")
            return layer  # Seqorth injection 건너뛰기, 원래 Qwen3 MoE 유지
        ...
        if moe_components['moe'] is None:
            ...
            if layer_idx >= self.config.first_k_dense_replace:
                logger.debug(f"Layer {layer_idx}: Adding Seqorth MoE to dense layer")
                seqorth_moe = SeqorthMoE(config=self.config, global_router=self.global_router)
                seqorth_moe.iter = layer_idx
                ...
                if original_mlp and self.copy_expert_weights:
                    with torch.no_grad():
                        for expert in seqorth_moe.experts:
                ...
                setattr(layer, moe_attr, seqorth_moe)
            return layer

        # MoE layer - SURGICAL HIJACKING
        logger.debug(f"Layer {layer_idx}: Surgically hijacking MoE router with Seqorth")
        ...
        # Copy config attributes needed by SeqorthMoE.forward
        for attr in ['top_k', 'num_experts', 'input_jitter_noise', 'router_jitter_noise',
            ...
            # Fallback for different SeqorthTextConfig attribute names
            if val is None:
        ...
        # Ensure 'experts' and 'shared_experts' aliases exist for SeqorthMoE.forward
        ...
        original_moe.forward = types.MethodType(SeqorthMoE.forward, original_moe)
        original_moe._sparse_routing = types.MethodType(SeqorthMoE._sparse_routing, original_moe)
        original_moe.compute_pairwise_expert_similarity = types.MethodType(SeqorthMoE.compute_pairwise_expert_similarity, original_moe)

        return layer

    def inject(self, model) -> nn.Module:
        """
        Inject Seqorth Exoskeleton into all decoder layers of a model using Surgical Hijacking.
        """
        model_type = self.detect_model_type(model)
        logger.info(f"💉 Injecting Seqorth Exoskeleton (Type: {model_type}) into base model...")
        ...
        if not hasattr(model, 'seqorth_global_router'):
            model.add_module('seqorth_global_router', self.global_router)
        ...
        logger.info(f"✅ Seqorth Exoskeleton injection complete ({len(layers)} layers hijacked)")

        return model


class SeqorthRotaryEmbedding(nn.Module):
    """
    [DEPRECATED - Use Exoskeleton Architecture]

    This is a Gemma3-specific RoPE implementation. For universal model support,
    use SeqorthExoskeletonMoEInjector which preserves the base model's native
    ...
    The Exoskeleton architecture injects Seqorth routing into pretrained models
    ...
    """
    def __init__(self, config: SeqorthTextConfig, device=None, **kwargs):
        super().__init__()
...
class SeqorthAttention(nn.Module):
    """
    [DEPRECATED - Use Exoskeleton Architecture]
    ...
    - Ensures compatibility with all major transformer architectures:
      Qwen3-VL-MoE, Llama4, DeepSeek-V3, GLM4V-MoE, GPT-OSS, Ernie4.5-MoE
    """
    def __init__(self, config: SeqorthTextConfig, layer_idx: int, **kwargs):
        super().__init__()
        ...
        self.q_norm = SeqorthRMSNorm(dim=config.head_dim, eps=config.rms_norm_eps)
        self.k_norm = SeqorthRMSNorm(dim=config.head_dim, eps=config.rms_norm_eps)
...
class SeqorthDecoderLayer(GradientCheckpointingLayer):
    def __init__(
        self,
        config: SeqorthTextConfig,
        layer_idx: int,
        global_router: SeqorthRouter, **kwargs
    ):
        super().__init__()
        self.config = config
        self.hidden_size = config.hidden_size
        ...
        self.self_attn = SeqorthAttention(config=config, layer_idx=layer_idx, **kwargs)
        self.is_dense_replacement = layer_idx >= config.first_k_dense_replace
        expert_intermediate_size = getattr(config, "moe_intermediate_size", 768)
        if self.is_dense_replacement:
            self.moe = SeqorthMoE(config=config, global_router=global_router)
        else:
            self.moe = SeqorthMLP(config=config, intermediate_size=expert_intermediate_size)
        self.input_layernorm = SeqorthRMSNorm(self.hidden_size, eps=config.rms_norm_eps)
        self.post_attention_layernorm = SeqorthRMSNorm(self.hidden_size, eps=config.rms_norm_eps)
        self.pre_feedforward_layernorm = SeqorthRMSNorm(self.hidden_size, eps=config.rms_norm_eps)
        self.post_feedforward_layernorm = SeqorthRMSNorm(self.hidden_size, eps=config.rms_norm_eps)
...
@auto_docstring
class SeqorthPreTrainedModel(PreTrainedModel):
    config: SeqorthConfig
    base_model_prefix = ""
    ...
    _supports_attention_backend = True
    _can_record_outputs = {
        "hidden_states": SeqorthDecoderLayer,
        "attentions": SeqorthAttention
    }
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, (nn.Linear, nn.Conv1d, nn.Conv2d, nn.Conv3d, nn.ConvTranspose1d, nn.ConvTranspose2d)):
            if getattr(module, "_is_seqorth_router", False):
        ...
        elif isinstance(module, SeqorthMultiModalProjector):
            # ZeRO-3 compatibility: Skip init if weights are partitioned (1D) or on meta
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        and then injects Seqorth's advanced routing system into its decoder layers.
        ...
        Seqorth's routing stability and expert specialization.
        """
        # Resolve configuration
        if config is None:
            config = AutoConfig.from_pretrained(pretrained_model_name_or_path, **kwargs.get("config_kwargs", {}))

        # Ensure it's a SeqorthConfig for MoE settings
        if not isinstance(config, (SeqorthConfig, SeqorthTextConfig)):
            # Convert base config to Seqorth config while preserving base model parameters
            config_dict = config.to_dict()
            if "text_config" in config_dict:
                # VLM case
                config = SeqorthConfig(**config_dict)
            else:
                # Text-only case
                config = SeqorthTextConfig(**config_dict)
        ...
        # We replace the base model's router/gate with Seqorth's global router mechanism
        force_upcycle = kwargs.get("force_upcycle", False)

        logger.debug("Initializing Seqorth Global Router...")
        # Initialize Seqorth Global Router
        ...
        logger.debug("Injecting Seqorth Routing Mechanism (Exoskeleton)...")
        ...
        # 3. Explicitly initialize newly injected Seqorth parameters
        ...
        if hasattr(base_model, "_initialize_moe_router_and_temperature"):
            # If it's a Seqorth-compatible class with the helper method
            base_model._initialize_moe_router_and_temperature()
        else:
            # Manual initialization for injected parameters in arbitrary models
            for module in base_model.modules():
                if hasattr(module, "router") and isinstance(module.router, SeqorthRouter):
                    # SeqorthRouter handles its own internal init, but we check weights
                    pass
                elif getattr(module, "_is_seqorth_router", False) and hasattr(module, "weight"):
                    if module.weight.dim() > 1 and not module.weight.is_meta:
                        nn.init.xavier_uniform_(module.weight)
                        if module.bias is not None: module.bias.data.zero_()

        logger.debug(f"Seqorth Exoskeleton successfully injected into {pretrained_model_name_or_path}")
        return base_model
...
@add_start_docstrings(
    "The bare SeqorthText Model outputting raw hidden-states without any specific head on top.",
    seqorth_START_DOCSTRING,
)
class SeqorthTextModel(SeqorthPreTrainedModel):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`SeqorthTextDecoderLayer`]
    ...
    def __init__(self, config: SeqorthTextConfig, **kwargs):
        ...
        if getattr(config, "model_type", None) == "seqorth_text" or not hasattr(config, "text_config"):
            self.config = config
        else:
        ...
        # Restore SeqorthTextScaledWordEmbedding for structural consistency
        # Fixed to avoid ZeRO-3 meta tensor conflicts by using float scale instead of buffer
        self.embed_tokens = SeqorthTextScaledWordEmbedding(
            config.vocab_size, config.hidden_size, self.padding_idx, embed_scale=self.config.hidden_size**0.5
        )
        self.global_router = SeqorthRouter(config)
        self.layers = nn.ModuleList(
            [SeqorthDecoderLayer(config, layer_idx, self.global_router, **kwargs) for layer_idx in range(config.num_hidden_layers)]
        )
        self.norm = SeqorthRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = SeqorthRotaryEmbedding(config=config)
        ...
        self.rotary_emb_local = SeqorthRotaryEmbedding(config=config)
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        return SeqorthModelOutputWithPast(
...
@auto_docstring
class SeqorthForCausalLM(SeqorthPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config: SeqorthTextConfig, **kwargs):
        super().__init__(config)
        self.model = SeqorthTextModel(config, **kwargs)
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        ```python
        >>> from transformers import AutoTokenizer, SeqorthForCausalLM

        >>> model = SeqorthForCausalLM.from_pretrained("google/gemma-2-9b")
        ...
        if self.training and self.config.attn_implementation != "eager":
            logger.warning_once(
                "It is strongly recommended to train Seqorth models with the `eager` attention implementation "
        ...
        return SeqorthCausalLMOutputWithPast(
            loss=loss,
            logits=logits,
...
class SeqorthMultiModalProjector(nn.Module):
    def __init__(self, config: SeqorthConfig, **kwargs):
        super().__init__()
        ...
        self.mm_soft_emb_norm = SeqorthRMSNorm(
...
@auto_docstring(
    custom_intro="""
    The Base Seqorth model which consists of a vision backbone and a language model withou language modeling head.,
    """
)
class SeqorthModel(SeqorthPreTrainedModel):
    config: SeqorthConfig
    _checkpoint_conversion_mapping = {"language_model.model": "language_model"}
    # we are filtering the logits/labels so we shouldn't divide the loss based on num_items_in_batch
    accepts_loss_kwargs = False

    def __init__(self, config: SeqorthConfig, vision_tower=None, language_model=None):
        super().__init__(config)
        ...
        self.language_model = language_model if language_model is not None else SeqorthTextModel.from_config(config=config.text_config, trust_remote_code=True)
        self.multi_modal_projector = SeqorthMultiModalProjector(config=config)
    ...
    def forward(
        ...
        **lm_kwargs,
    ) -> Union[tuple, SeqorthModelOutputWithPast]:
        r"""
        labels (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
            Labels for computing the masked language modeling loss. Indices should either be in `[0, ...,
        ...
        >>> import requests
        >>> from transformers import AutoProcessor, SeqorthForConditionalGeneration

        >>> model = SeqorthForConditionalGeneration.from_pretrained("google/gemma32-3b-mix-224")
...
@add_start_docstrings(
    """The Seqorth model which consists of a vision backbone and a language model.""",
    seqorth_START_DOCSTRING,
)
class SeqorthForConditionalGeneration(SeqorthPreTrainedModel, GenerationMixin):
    _checkpoint_conversion_mapping = {
        "^language_model.model": "model.language_model",
        "^visual": "model.visual",
        "^multi_modal_projector": "model.multi_modal_projector",
        "^language_model.lm_head": "lm_head",
        # MoE key mapping: Qwen uses "mlp", Seqorth uses "moe"
        r"\.mlp\.": ".moe.",
        # LayerNorm key mapping: Qwen uses "post_attention_layernorm", Seqorth uses "post_feedforward_layernorm"
    ...
    def __init__(self, config: SeqorthConfig, vision_tower=None, **kwargs):
        super().__init__(config)
        self.model = SeqorthModel(config, vision_tower=vision_tower)
    ...
    def forward(
        ...
        logits_to_keep: Union[int, torch.Tensor] = 0,
        **lm_kwargs,
    ) -> Union[Tuple, SeqorthCausalLMOutputWithPast]:
        r"""
        labels (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
            Labels for computing the masked language modeling loss. Indices should either be in `[0, ...,
            config.text_config.vocab_size]` or -100 (see `input_ids` docstring). Tokens with indices set to `-100` are ignored
        ...
        >>> model = SeqorthForConditionalGeneration.from_pretrained("google/gemma-3-4b-it")
        ...
        outputs: SeqorthModelOutputWithPast = self.model(
            input_ids=input_ids,
            pixel_values=pixel_values,
...
class SeqorthRouterTrainingMonitor:
    """
    ...
    def _iter_router_modules(self):
        for name, module in self.model.named_modules():
            if getattr(module, "_is_seqorth_router", False) or isinstance(module, SeqorthRouter):
                yield name, module
    ...
    def on_after_backward(
        self,
        outputs: Optional[Union[SeqorthCausalLMOutputWithPast, SeqorthModelOutputWithPast]] = None,
        attention_mask: Optional[torch.Tensor] = None,
    ):
