...
class SeqorthRouter(nn.Module):
    def __init__(self, config: SeqorthTextConfig, **kwargs):
        ...
        # Curriculum / step tracking (align with trainable_seqorth so step 1 is reachable)
    ...
    def forward(self, x, hn=None, top_k=2, jitter_eps=0.01, step_frac=0.0, layer_idx=0):
        """
        Agentic Seqorth Routing (ALF + GLN + Global Intent)
        ...
        if is_dummy_batch:
            ...
            load_balancing_loss = seqorth_lb_loss(
                biased_logits,
                E,
...
class SeqorthMoE(nn.Module):
        ...
        **kwargs
        ...
        if _DISABLE_SHARED_EXPERTS:
            ...
            with torch.no_grad():
                ...
                # deadlock during backward / gradient checkpointing (see NOTE in SeqorthMoE.forward).
    ...
    def _sparse_routing(
        ...
        if not isinstance(self.experts, nn.ModuleList) and callable(self.experts):
            ...
            # trainable_seqorth uses direct call - proven deadlock-free.
            ...
            for expert_idx in range(self.num_experts):
                ...
                # [ZeRO-3 Fix] Lightweight Parameter Guard (from trainable_seqorth)
